...
(function($){
	...
	$.extend($.fn, {
		...
		comboxOption: function(selector, box){
			console.log('comboxOption');//有级联下级的触发
			return this.each(function(){
		...
		combox:function(){
			...
			return this.each(function(i){
				...
				// var value= $this.val();
				/*---->*/
				var value= $this.attr('jvalue')?$this.attr('jvalue'):$this.val();
				$this.val(value);
				/*<----*/
				...
				if (ref && refUrl) {
					function _onchange(event){
						...
						console.log();
						$.ajax({
							type:'POST',global:false, dataType:"json", url:refUrl.replace("{value}", encodeURIComponent($this.attr("value"))), cache: false,
							data:{},
