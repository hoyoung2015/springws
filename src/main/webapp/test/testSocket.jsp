    ...
    <script type="text/javascript">
        ...
        function connect() {
            ...
            if ('WebSocket' in window) {
                ws= new WebSocket("ws://localhost:8080/treasure/api");
            }else {
                ws = new SockJS("http://localhost:8080/treasure/sockjs/api");
            }
            //websocket = new SockJS("http://localhost:8080/treasure/sockjs/websck");
            ws.onopen = function () {
                console.log('open');
                setConnected(true);
...
<div>
    <div id="connect-container">
        ...
        <br>
        <input id="radio2" type="radio" name="group1" onclick="updateUrl('/test/sockjs/websocket');">
